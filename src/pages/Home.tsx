      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="wrap relative z-10 pt-24 sm:pt-32 pb-20 text-center max-w-[720px]">
          ...
          <motion.div {...fadeUp} transition={{ delay: 0.1, duration: 0.6, ease }}>
            <div className="flex max-w-[520px] mx-auto bg-white/12 backdrop-blur-xl border border-white/15 rounded-full p-1 sm:p-1.5 mb-8">
              <input
                type="text"
              ...
              <Button variant="primary" size="default" className="rounded-full shrink-0">
                <Search size={14} /> <span className="hidden sm:inline">Search plans</span>
              </Button>
            </div>
          </motion.div>
